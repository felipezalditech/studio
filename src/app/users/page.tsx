...
export default function UsersPage() {
  return (
    <div className="container mx-auto py-10">
      ...
      <p className="text-muted-foreground">Esta é a página de gerenciamento de usuários. O conteúdo será adicionado aqui.</p>
      ...
      <div className="mt-8 p-8 border rounded-lg bg-card text-card-foreground">
        ...
        <p>Funcionalidades de gerenciamento de usuários e permissões estarão disponíveis aqui.</p>
      </div>
    </div>
  );
}
