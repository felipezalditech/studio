  ...
  return (
    <div className="container mx-auto py-10 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Gerencie as informações e o logo da sua empresa.</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Defina o nome e o logo da sua empresa que aparecerão em relatórios e outras áreas.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...brandingForm}>
